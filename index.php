...
<div class="shell">
  ...
  <div id="main">
    ...
    <div id="content">
      ...
      <!-- Products -->
      <div class="products">
     <h1> Welcome to Osikie Studio Photography</h1>
     &nbsp;
     <ul>OSIKIE STUDIO provides the complete photography solution.
We are dedicated to providing a friendly, effiecient service for all your photography needs.</ul>
<ul>OSIKIE STUDIO work on location or in the studio can provide and covers all types of portraits, model and fashion, school and company events, birthday party or family events, prewedding and weddings.</ul>
<ul>Our studio in Sun Plaza floor 3 street Kh.Zainul Arifin Medan North Sumatera, with a permanent and portable studio with 3D concept,  and operated by professional photographers will personally handle to capture and make the amazing moment.
</ul>
&nbsp;
<ul>Thank you for considering OSIKIE STUDIO for photographing your needs.</ul>
&nbsp;
<ul>Warm Regards... </ul>
