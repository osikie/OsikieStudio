  ...
  <div id="header">
    ...
    <div id="navigation">
      ...
      <ul>
        ...
        <li><a href="tengah.php?module=keranjangbelanja" target="_parent">Keranjang Belanja</a></li>
	...
	while($row=mysql_fetch_array($tampil)){ ?>
                    ...
                    <div class="product_box margin_r35">
                      ...
                      <p align="center" class="price">Rp. <?php echo $row[harga]?></p>
                        <div align="center"><a href="<?php echo "aksi.php?module=keranjang&act=tambah&id=$row[id_produk]" ?>">add to cart</a>
